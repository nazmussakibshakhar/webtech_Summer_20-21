...
<body>
     <head>
     <script src="view/js/Change Pass.js"></script>
     </head>
<fieldset>
<?php
session_start();
...
<table>
<tr><td align = "left">Current Password</td><td align = "right">:<input type = "text" name = "curpass" value="<?php echo  $_SESSION['pass'];?>">   </td> <span id="Uerror" style="color: red;"> * <?php echo $pass_error;  ?></span> <br><br>
<tr><td align = "left"><span style = "color:green;">New Password</span></td><td align = "right">:<input type = "text" name="newpass"></td>  <span id="Perror" style="color: red;"> * <?php echo $pass_error;  ?></span> <br><br>
